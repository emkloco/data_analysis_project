...
class HollowVisualizer:
    def run(self):
        ...
        plt.title('Figure 1. Shifts in the UK Income Distribution Over Time', fontsize=16)
        ...
        plt.savefig(config.FIGURES_DIR / "01_hollow_middle.png", dpi=300, bbox_inches='tight')
        print("saved fig 1")
